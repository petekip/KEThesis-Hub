    ...
    <div class="container-fluid">
        <div class="side-body">
        	<h4 style="display: inline-block;">Staff </h4>
        	...
        	<div class="col-md-12">
        		<div class="panel">
        			<div class="panel-body" id="frminfo" style="display: none;">
        				...
        				<form class="form" method="post" action="add_staff" id="afrminfo">
        					...
        					<div class="form-group">
        						...
        						<div class="result"></div>
                                        ...
                                        <div class="panel-body" id="frmeditinfo" style="display: none;">
                        <div class="eresult"></div>
                        <form class="form" method="post" action="edit_info" id="efrminfo">
                            ...
                            <div class="form-group">
                                <label>ID: </label>
                                <input type="text" name="eidno" id="eidno" class="form-control">
                            </div>
                            <div class="form-group">
                                <label></label>
